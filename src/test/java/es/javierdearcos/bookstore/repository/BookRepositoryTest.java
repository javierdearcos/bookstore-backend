...
public class BookRepositoryTest {
    ...
    @Test
    public void shouldCreatedBookTitleBeSanitized() {
        Book newBook = new Book("   title  to sanitize ", "the book description", 24.99f, "isbn", new Date(),
                300, "http://image.url", Language.ENGLISH);
        newBook = bookRepository.create(newBook);

        assertNotNull("title to sanitize", newBook.getTitle());
    }
